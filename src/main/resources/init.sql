...
#
INSERT INTO uploader (id, username, password, email,avatar,hot_value,update_time) VALUES (1, 'root', '123456', 'root@mijack.cn','http://localhost:8080/favicon.ico',0,'2017-09-26 00:00:00');
INSERT INTO uploader (id, username, password, email,avatar,hot_value,update_time) VALUES (2, 'admin', '123456', 'admin@mijack.cn','http://localhost:8080/favicon.ico',0,'2017-09-26 00:00:00');
INSERT INTO uploader (id, username, password, email,avatar,hot_value,update_time) VALUES (3, 'mijack', '123456', 'mijack@mijack.cn','http://localhost:8080/favicon.ico',0,'2017-09-26 00:00:00');
#
